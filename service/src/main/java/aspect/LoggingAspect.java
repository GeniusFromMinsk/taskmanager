...
public class LoggingAspect {
    ...
    @Before("execution(* com.itclopedia.courses.services..*(..))")
    public void logBefore(JoinPoint joinPoint) {
        logger.info("Entering method: {} with arguments: {}", joinPoint.getSignature(), joinPoint.getArgs());
    }

    @AfterReturning(pointcut = "execution(* com.itclopedia.courses.services..*(..))", returning = "result")
    public void logAfterReturning(JoinPoint joinPoint, Object result) {
        logger.info("Method: {} returned with value: {}", joinPoint.getSignature(), result);
    }

    @Around("execution(* com.itclopedia.courses.services..*(..))")
